...
20251009
added locostage params from 20251009_flybubble_LED_VNC3
note - stats params don't match - no idea what state they are in

20260204
added filename for locostatsperexp to dataloc_params
...
20260622
forked from 20260326_flybubble_LED_VNC2
added do_onfloor_filtering,1 and save_swingstancebouts,1 to locomotionmetrics_params.txt

20260623
added velmag_bin_edges,8,20 to locomotionmetrics_params.txt (interior edges for slow/med/fast speed bins)

20260624
set save_swingstancebouts,0 for production run - only save the swingstancebouts file for debug runs
