...
20260518
copied from FlyDiscoAnalysis/settings/20260326_flybubble_LED_VNC2
new settings dir for reprocessing the registration bug
analysis-protocol-parameters.txt: dolocomotionmetrics force -> off
  (reprocessing registration on main branch; locostage code not in main yet)
